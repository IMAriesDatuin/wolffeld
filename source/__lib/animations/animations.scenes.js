...
var $areYouACandidateH1SplitText = new SplitText(animAreYouACandidate.find("h1"), {type: "words, chars, lines"}), 
	...
	//areYouACandidateParagraphSplitText = $areYouACandidateParagraphSplitText.words;
...
var tlAreYouACandidate = new TimelineMax({paused: true});
	tlAreYouACandidate.staggerFrom(areYouACandidateH1SplitText, 0.75, {autoAlpha: 0, x: -10, ease: Back.easeOut}, 0.02, "group-01")
					 .from(animAreYouACandidate.find("p"), 1, {autoAlpha: 0, ease: Expo.easeOut}, "group-01")
					.add(
					  function() {
...
var $theARTASExperienceH1SplitText = new SplitText(animTheARTASExperience.find("h1"), {type: "words, chars, lines"}), 
	theARTASExperienceH1SplitText = $theARTASExperienceH1SplitText.chars;

	//$theARTASExperienceParagraphSplitText = new SplitText(animTheARTASExperience.find("p"), {type: "words, chars, lines"}), 
	//theARTASExperienceParagraphSplitText = $theARTASExperienceParagraphSplitText.words;
...
var $whatSetsARTASApartH1SplitText = new SplitText(animWhatSetsARTASApart.find("h1"), {type: "words, chars, lines"}), 
	whatSetsARTASApartH1SplitText = $whatSetsARTASApartH1SplitText.chars,
