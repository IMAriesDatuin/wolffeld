...
var utilAssetObserver=function(){var e=$(".img-bg-resize");e.parent().addClass("background-pattern"),e.css({width:"100%",height:"100%","min-height":"400px","background-repeat":"repeat","transition-property":"background-position"});var a=function(){e.each(function(){var e=$(this),a=e.css("background-image");if("none"!==a){a=a.replace('url("',"").replace('")',"");var t=new Image;t.src=a,t.onload=function(){e.css({width:"100%",height:t.height,"background-repeat":"no-repeat"}),e.parent().css({height:t.height/1.25}),$isMobile&&0===orientation?e.parent().css({height:t.height/1}):$isMobile&&90===orientation&&e.parent().css({height:1*t.height})}}})};$$(window).on("resize orientationchange",_.debounce(a,$updateInterval));var t={container:document,elements_selector:".lazy",threshold:100,load_delay:300,data_src:"src",data_srcset:"srcset",data_sizes:"sizes",class_loading:"loading",class_loaded:"loaded",class_error:"error",callback_enter:function(e){$(e).imagesLoaded({background:!0}).always(function(){}).progress(function(e,a){})},callback_load:null,callback_set:function(e){$(e).imagesLoaded({background:!0}).done(function(){a()}).fail(function(){})},callback_error:null,to_webp:!0};new LazyLoad(t)},mediaVideo=$(".video");mediaVideo.video({attr_ready:"data-video-ready",attr_playing:"data-video-playing",attr_paused:"data-video-paused"}),$$(".play").on("click",function(){mediaVideo.playVideo()});var utilMediaObserver=function(){mediaVideo.is("[data-video-paused]"),mediaVideo.is("[data-video-playing]")&&mediaVideo.pauseVideo()},utilDataAttributes=function(){"use strict";for(var e=document.querySelectorAll("[data-color]"),a=0;a<e.length;a++){var t=e[a].getAttribute("data-color");e[a].style.backgroundColor=t}for(var i=document.querySelectorAll("[data-page]"),o=0;o<i.length;o++)i[o].getAttribute("data-page");var n=document.querySelectorAll("[data-image]");if(Modernizr.webp&&Modernizr.webp.lossless&&Modernizr.webp.alpha&&Modernizr.webp.animation)for(var r=0;r<n.length;r++){var l=n[r].getAttribute("data-image").replace(/jpg|png/gi,"webp");n[r].style.backgroundImage="url('"+l+"')"}else for(r=0;r<n.length;r++){l=n[r].getAttribute("data-image").replace(/webp/gi,"png");n[r].style.backgroundImage="url('"+l+"')"}},utilEmergence=function(){var e=document.querySelector(".scroll"),a=$("[data-emergence]"),t=$(".emergence-ignore");document.querySelector("video");$isMobile||$hasTouch||TweenMax.set(a.not(t).children().not(t).not(anim).children(),{opacity:0}),emergence.init({container:e,reset:!0,handheld:!0,throttle:$updateInterval,elemCushion:0,offsetTop:0,offsetRight:0,offsetBottom:0,offsetLeft:0,callback:function(e,a){"visible"===a?($isMobile||$hasTouch||TweenMax.staggerTo($(e).not(t).children().not(t).not(anim).children(),1,{opacity:1,delay:0,ease:Power4.easeOut,overwrite:"false",clearProps:"all"},.12),$(e).find(".anim").removeClass("anim-pause").addClass("anim-play"),$("video.anim-play").each(function(e){$(this)[0].play()})):"reset"===a&&($(e).find(".anim").addClass("anim-pause").removeClass("anim-play"),$(e).find(".video[data-video-playing]").pauseVideo(),$("video.anim-pause").each(function(e){$(this)[0].pause()}))}}),emergence.engage()},utilPageVisibility=function(){"use strict";var e=$(".page-visibility"),a=$(".page-visibility-ignore");new Visibility({onHidden:function(){animCore(),utilMediaObserver(),TweenMax.set(e.not(a),{opacity:0})},onVisible:function(){animCore(),utilMediaObserver(),TweenMax.staggerTo(e.not(a),.25,{opacity:1,ease:Power2.easeInOut},.12)}})},utilPrint=function(){"use strict";$(".print").click(function(){$$(window).print({addGlobalStyles:!1,mediaPrint:!1,stylesheet:null,rejectWindow:!0,noPrintSelector:".no-print",iframe:!0,append:null,prepend:"<div class='display-block position-absolute left p4 font-header text-primary' style='top: 1em;'>AXEL</div> <div class='display-block position-absolute right p10 font-paragraph text-dark-grey' style='top: 2em;'>Last Updated: 005.31.18</div>"})})},utilScrollProgress=function(){var e=$(window).scrollTop()/($(document).height()-$(window).height())*100;$$(".scroll-progress").css({width:e+"%"})};$$(window).on("scroll",_.throttle(utilScrollProgress,$updateInterval,{trailing:$throttleTrail,leading:$throttleLeading}));
var comDialog=function(){var d=$("#dialog"),e=$("#dialog").find(".close"),a=$("#blocker"),t=$("[data-content-selector]");($isEdge||$isExplorer)&&d.css({left:"50%",transform:"translate(-50%,-50%)"});var i=function(){html.hasClass("inactive")?TweenMax.to(a,.25,{display:"none",opacity:0,onStart:function(){enableContent(),html.removeClass("inactive"),a.addClass("no-pointer")}}):TweenMax.to(a,.25,{display:"block",opacity:.25,onStart:function(){disableContent(),html.addClass("inactive"),a.addClass("no-pointer")},onComplete:function(){a.removeClass("no-pointer")}})},l=function(l,s){i(),html.hasClass("inactive")?TweenMax.to(d,.25,{display:"none",opacity:0,ease:Expo.easeOut,onComplete:function(){d.attr("aria-labelledby","Inactive").attr("aria-describedby","This dialog window is currently inactive.").find("#dialog-container").html("")}}):TweenMax.to(d,.25,{display:"block",opacity:1,ease:Expo.easeOut,onStart:function(){html.addClass("no-pointer"),d.find("#dialog-container").load(l+s,function(e,a,t){if(d.find("#dialog-error").addClass("hide").find("p").text(""),TweenMax.set(d.find("#dialog-preloader"),{display:"block",opacity:1,scale:1}),"success"==a){var i=d.find("#dialog-title").text(),o=d.find("#dialog-description").text();if(d.find("#dialog-title").length?d.attr("aria-labelledby",i):d.attr("aria-labelledby","Dialog"),d.find("#dialog-description").length?d.attr("aria-describedby",o):d.attr("aria-describedby",""),!d.find("#dialog-container").find(s).length){var n="Error: Unable to load "+l+s;d.find("#dialog-error").removeClass("hide").find("p").text(n)}TweenMax.to(d.find("#dialog-preloader"),.25,{display:"none",opacity:0,scale:.75,delay:0,ease:Expo.easeOut})}else{n="Error: Unable to load "+l+s;TweenMax.to(d.find("#dialog-preloader"),.25,{display:"none",opacity:0,scale:.75,delay:1,ease:Expo.easeOut,onComplete:function(){d.find("#dialog-error").removeClass("hide").find("p").text(n)}}),d.attr("aria-labelledby","Error").attr("aria-describedby","We're sorry. This content is currently unavailable.")}})},onComplete:function(){html.removeClass("no-pointer")}})};a.on("click",function(e){e.preventDefault(),i(),l()}),t.on("click",function(e){e.preventDefault();var a,t,i=$(this),o=null,n=i.data("content-selector");"auto"===i.data("content-width")&&window.matchMedia("(max-width: 1500px)").matches?(d.addClass("dialog-width-auto"),a=window.innerWidth/1.2):"auto"===i.data("content-width")?(d.addClass("dialog-width-auto"),a=1024):(d.removeClass("dialog-width-auto"),a=i.data("content-width")),"auto"===i.data("content-height")&&window.matchMedia("(max-height: 1500px)").matches?(d.addClass("dialog-height-auto"),t=window.innerHeight/1.2):(d.removeClass("dialog-height-auto"),t=i.data("content-height")),o=i.is("a")?i.attr("href"):i.data("content-url"),$isMobile&&d.css({left:"50%",transform:"translate(-50%,-50%)"}),l(o," #"+n),TweenMax.set(d,{width:a,height:t})}),e.on("click",function(e){e.preventDefault(),l()}),$$(window).on("resize",_.debounce(function(){d.length&&d.hasClass("dialog-width-auto")&&window.matchMedia("(max-width: 1500px)").matches&&TweenMax.to(d,.25,{width:window.innerWidth/1.2,ease:Power4.easeOut}),d.length&&d.hasClass("dialog-height-auto")&&window.matchMedia("(max-height: 1500px)").matches&&TweenMax.to(d,.25,{height:window.innerHeight/1.2,ease:Power4.easeOut})},100))},comParallax=function(){var e=$(".dzsparallaxer");dzsprx_init(e,{direction:"reverse",settings_mode:"scroll",mode_scroll:"normal",animation_duration:"2",easing:"easeInOutSine"})},comSlider=function(){"use strict";var e=$(".slider-default"),a=$(".slider-default.adapt").flickity();TweenMax.fromTo(e,.5,{autoAlpha:0},{autoAlpha:1,delay:1});TweenMax.delayedCall($delayInterval,function(){e.flickity("resize")}),e.has(".adapt").each(function(){var e=$(this);e.find("ol.flickity-page-dots").prependTo($(this).find(".flickity-viewport")),e.find(".flickity-viewport").css("height",$(this).find(".flickity-viewport .slider-item.is-selected").children().height()+"px")}),$(".slider-item a").on("click touchdown",function(e){}),a.on("select.flickity",function(){var e=$(this);e.each(function(){e.find(".flickity-viewport").css("height",$(this).find(".flickity-viewport .slider-item.is-selected .cell").height()+"px")})});$$(window).on("scrollstop",function(){e.each(function(){var e=$(this);e.hasClass("anim-play")?e.flickity("playPlayer"):e.flickity("stopPlayer")})})},comStories=function(){var e=$("#stories .profiles .cell");$("#stories .profiles"),$("#josh"),$("#shera"),$("#tina");TweenMax.set(e.find("[data-src]"),{autoAlpha:0,scale:1.12}),e.on("mouseover touchstart",function(){var e=$(this);new TimelineMax({paused:!1}).add(function(){e.addClass("overflow-hidden")},"group-1").to(e.find(".story-icon"),.75,{autoAlpha:0,scale:.75,ease:Back.easeOut},"group-1").to(e.find(".text-container"),1,{autoAlpha:0,ease:Power4.easeOut},"group-1").to(e.find(".button"),1,{autoAlpha:0,ease:Power4.easeOut},"group-1").to(e.find("[data-src]"),.5,{autoAlpha:1,scale:1,ease:Power4.easeOut},"group-1")}).on("mouseout touchend touchleave",function(){var e=$(this);new TimelineMax({paused:!1}).to(e.find(".text-container"),.75,{autoAlpha:1,ease:Power4.easeOut},"group-1").to(e.find(".button"),.75,{autoAlpha:1,ease:Power4.easeOut},"group-1").to(e.find("[data-src]"),.25,{autoAlpha:0,scale:1.12,ease:Power4.easeOut},"group-1").to(e.find(".story-icon"),.5,{autoAlpha:1,scale:1,ease:Back.easeOut},"group-1").add(function(){e.removeClass("overflow-hidden")},"group-1")})};
